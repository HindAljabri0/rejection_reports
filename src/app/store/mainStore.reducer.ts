        ...
        const userPrivileges = {
            ...
            ProviderPrivileges: {
                ...
                NPHIES: {
                    ...
                    canAccessPriceList: providerId != '101' &&(AuthService.hasPrivilege(providerId, '101', '25.61') || AuthService.hasPrivilege(providerId, '101', '25.6')),
                    canAccessPhysician: providerId != '101' && (AuthService.hasPrivilege(providerId, '101', '25.62') || AuthService.hasPrivilege(providerId, '101', '25.6')),
                }
            }
        };
