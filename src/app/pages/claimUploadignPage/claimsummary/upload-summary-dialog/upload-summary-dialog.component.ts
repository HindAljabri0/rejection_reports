...
export class UploadSummaryDialogComponent implements OnInit {
  ...
  getClaimSummaryByFieldName(page = null) {
    ...
    this.uploadService.getClaimsErrorByFieldName(this.commen.providerId, this.uploadService.summary.uploadSummaryID, this.dialogData.fieldName, page).subscribe(event => {
