...
export class GeneralSummaryStatementReportComponent implements OnInit {
  ...
  manualPage = 0;
  minDate: any;
  constructor( public datepipe: DatePipe,public commen: SharedServices,public searchService:SearchService) { }
  ...
  search() {
    ...
    this.searchService.getGssData(this.commen.providerId,this.payerId,fromDate,toDate,this.tempPage,this.tempPageSize).subscribe((data:any)=>{
