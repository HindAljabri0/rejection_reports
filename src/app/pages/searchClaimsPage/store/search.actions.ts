...
export const toggleAssignedAttachmentLoading = createAction('[ Search - Attachment Management ] toggle loading for assigned attachments section', props<{ isLoading: boolean }>());
...
export const saveAttachmentsChanges = createAction('[ Search - Attachment Management ] send a attachments change save request to back end for all changed claims');

export const storeAttachmentsChangesResponse = createAction('[ Search - Attachment Management ] store the responses in current state', props<{ responses: { id: string, status: string, error?}[] }>());

export const showErrorMessage = createAction('[ Search - Attachment Management ] show error message to user', props<{ error: { code: string, message?: string } }>());
