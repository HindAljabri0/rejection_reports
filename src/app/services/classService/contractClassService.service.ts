...
export class ContractClassService {
    ...
    getClassBySearchParam(reqParam: classRequest, providerId: string) {
        const requestUrl = `/class/${providerId}/search`;
    ...
    ManipulateClass(cont_class: classCrudRequest, providerId: string) {
        const requestUrl = `/class/${providerId}/manipulate`;
