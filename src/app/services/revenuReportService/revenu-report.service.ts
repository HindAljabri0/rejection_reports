...
export class RevenuReportService {
  ...
  generateRevenuBreakingReport(providerId: string, data: RevenuTrackingReport): Observable<any> {
    const requestURL = `/providers/${providerId}/revenue-breakthrough/${data.subcategory}`;
