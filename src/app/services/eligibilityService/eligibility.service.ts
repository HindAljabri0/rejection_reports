...
export class EligibilityService {
  ...
  public checkEligibilityByDateOrUploadId(providerId: string, payerId: string, from: string, to: string, batchId: string, uploadId: string, casetype: string, claimRefNo: string, memberId: string, invoiceNo: string, patientFileNo: string, policyNo: string) {
