...
export class SharedDataService {
    ...
    prescriberRoutes = [
        ...
        { value: 'CONJUNCTIVAL', name: 'Conjunctival' },
        { value: 'CUTANEOUS', name: 'Cutaneous' },
        { value: 'DENTAL', name: 'Dental' },
        { value: 'ENDOCERVICAL', name: 'Endocervical' },
        { value: 'ENDOSINUSIAL', name: 'Endosinusial' },
        { value: 'ENDOTRACHEAL', name: 'Endotracheal' },
        { value: 'ENTERAL', name: 'Enteral' },
        { value: 'EPIDURAL', name: 'Epidural' },
        { value: 'EXTRA-AMNIOTIC', name: 'Extra-amniotic' },
        { value: 'HEMODIALYSIS', name: 'Hemodialysis' },
        { value: 'INFILTRATION', name: 'Infiltration' },
        { value: 'INTERSTITIAL', name: 'Interstitial' },
        { value: 'INTRA-ABDOMINAL', name: 'Intra-abdominal' },
        { value: 'INTRA-AMNIOTIC', name: 'Intra-amniotic' },
        { value: 'INTRA-ARTERIAL', name: 'Intra-arterial' },
        { value: 'INTRA-ARTICULAR', name: 'Intra-articular' },
        { value: 'INTRABILIARY', name: 'Intrabiliary' },
        { value: 'INTRABRONCHIAL', name: 'Intrabronchial' },
        { value: 'INTRABURSAL', name: 'Intrabursal' },
        { value: 'INTRACARDIAC', name: 'Intracardiac' },
        { value: 'INTRACARTILAGINOUS', name: 'Intracartilaginous' },
        { value: 'INTRACORNEAL', name: 'Intracorneal' },
        { value: 'INTRACORONARY', name: 'Intracoronary' },
        { value: 'INTRACORPORUS CAVERNOSUM', name: 'Intracorporus cavernosum' },
        { value: 'INTRADERMAL', name: 'Intradermal' },
        { value: 'INTRADISCAL', name: 'Intradiscal' },
        { value: 'INTRADUCTAL', name: 'Intraductal' },
        { value: 'INTRADUODENAL', name: 'Intraduodenal' },
        { value: 'INTRADURAL', name: 'Intradural' },
        { value: 'INTRAEPIDERMAL', name: 'Intraepidermal' },
        { value: 'INTRAESOPHAGEAL', name: 'Intraesophageal' },
        { value: 'INTRAGASTRIC', name: 'Intragastric' },
        { value: 'INTRAGINGIVAL', name: 'Intragingival' },
        { value: 'INTRAILEAL', name: 'Intraileal' },
        { value: 'INTRALESIONAL', name: 'Intralesional' },
        { value: 'INTRALUMINAL', name: 'Intraluminal' },
        { value: 'INTRALYMPHATIC', name: 'Intralymphatic' },
        { value: 'INTRAMEDULLARY', name: 'Intramedullary' },
        { value: 'INTRAMENINGEAL', name: 'Intrameningeal' },
        { value: 'INTRAMUSCULAR', name: 'Intramuscular' },
        { value: 'INTRAOCULAR', name: 'Intraocular' },
        { value: 'INTRAOVARIAN', name: 'Intraovarian' },
        { value: 'INTRAPERICARDIAL', name: 'Intrapericardial' },
        { value: 'INTRAPERITONEAL', name: 'Intraperitoneal' },
        { value: 'INTRAPLEURAL', name: 'Intrapleural' },
        { value: 'INTRAPROSTATIC', name: 'Intraprostatic' },
        { value: 'INTRAPULMONARY', name: 'Intrapulmonary' },
        { value: 'INTRASINAL', name: 'Intrasinal' },
        { value: 'INTRASPINAL', name: 'Intraspinal' },
        { value: 'INTRASYNOVIAL', name: 'Intrasynovial' },
        { value: 'INTRATENDINOUS', name: 'Intratendinous' },
        { value: 'INTRATESTICULAR', name: 'Intratesticular' },
        { value: 'INTRATHECAL', name: 'Intrathecal' },
        { value: 'INTRATHORACIC', name: 'Intrathoracic' },
        { value: 'INTRATUBULAR', name: 'Intratubular' },
        { value: 'INTRAUMOR', name: 'Intratumor' },
        { value: 'INTRA TYMPANIC', name: 'Intratympanic' },
        { value: 'INTRAUTERINE', name: 'Intrauterine' },
        { value: 'INTRAVASCULAR', name: 'Intravascular' },
        { value: 'INTRAVENOUS', name: 'Intravenous' },
        { value: 'INTRAVENOUS BOLUS', name: 'Intravenous bolus' },
        { value: 'INTRAVENOUS DRIP', name: 'Intravenous drip' },
        { value: 'INTRAVENRICULAR', name: 'Intraventricular' },
        { value: 'INTRAVESICAL', name: 'Intravesical' },
        { value: 'INTRAVITREAL', name: 'Intravitreal' },
        { value: 'IONTOPHORESIS', name: 'Iontophoresis' },
        { value: 'IRRIGATION', name: 'Irrigation' },
        { value: 'LARYNGEAL', name: 'Laryngeal' },
        { value: 'NASAL', name: 'Nasal' },
        { value: 'NASOGASTRIC', name: 'Nasogastric' },
        { value: 'OCCLUSIVE DRESSING TECHNIQUE', name: 'Occlusive dressing technique' },
        { value: 'OPHTHALMIC', name: 'Ophthalmic' },
        { value: 'ORAL', name: 'Oral' },
        { value: 'OROPHARYNGEAL', name: 'Oropharyngeal' },
        { value: 'OTIC (AURICULAR)', name: 'Otic (auricular)' },
        { value: 'PERCUTANEOUS', name: 'Percutaneous' },
        { value: 'PERIARTICULAR', name: 'Periarticular' },
        { value: 'PERIDURAL', name: 'Peridural' },
        { value: 'PERINEURAL', name: 'Perineural' },
        { value: 'PERIODONTAL', name: 'Periodontal' },
        { value: 'RECTAL', name: 'Rectal' },
        { value: 'RESPIRATORY (INHALATION)', name: 'Respiratory (inhalation)' },
        { value: 'RETROBULBAR', name: 'Retrobulbar' },
        { value: 'SOFT TISSUE', name: 'Soft tissue' },
        { value: 'SUBARACHNOID', name: 'Subarachnoid' },
        { value: 'SUBCONJUNCTIVAL', name: 'Subconjunctival' },
        ...
        { value: 'TRANSMUCOSAL', name: 'Transmucosal' },
        { value: 'TRANSPLACENTAL', name: 'Transplacental' },
        { value: 'TRANSTRACHEAL', name: 'Transtracheal' },
        { value: 'URETERAL', name: 'Ureteral' },
        { value: 'URETHRAL', name: 'Urethral' },
