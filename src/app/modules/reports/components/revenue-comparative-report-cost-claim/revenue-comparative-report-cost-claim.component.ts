...
@Component({
  selector: 'app-revenue-comparative-report-cost-claim',
  templateUrl: './revenue-comparative-report-cost-claim.component.html',
  styles: []
})
export class RevenueComparativeReportCostClaimComponent implements OnInit {
