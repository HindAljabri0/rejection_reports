...
@Component({
    selector: 'app-rejection-breakdown-report',
    templateUrl: './rejection-breakdown-report.component.html',
    styles: []
  })
export class RejectionBreakdownReportComponent implements OnInit, AfterViewInit {
    chartMode = 0;
