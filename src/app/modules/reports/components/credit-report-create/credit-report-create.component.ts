...
import { CreditReportCreateConfirmDialogComponent } from '../credit-report-create-confirm-dialog/credit-report-create-confirm-dialog.component';
...
export class CreditReportCreateComponent implements OnInit {
  ...
  saveClick(form: NgForm) {
    ...
    const dialogRef = this.dialog.open(CreditReportCreateConfirmDialogComponent, { panelClass: ['primary-dialog'], autoFocus: false, data: this.bupaRejectionReportData });
