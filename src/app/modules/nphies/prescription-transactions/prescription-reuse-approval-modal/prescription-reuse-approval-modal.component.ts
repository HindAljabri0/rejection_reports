...
@Component({
  selector: 'app-prescription-reuse-approval-modal',
  templateUrl: './prescription-reuse-approval-modal.component.html',
  styleUrls: ['./prescription-reuse-approval-modal.component.css']
})
export class PrescriptionReuseApprovalModalComponent implements OnInit {

  IsDescriptionLoaded = false;

  constructor(
    private dialogRef: MatDialogRef<PrescriptionReuseApprovalModalComponent>,
