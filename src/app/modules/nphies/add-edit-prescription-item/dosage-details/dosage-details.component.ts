...
onOptionChange: string = '';
  ...
  onSubmit() {
    ...
    //   }
      ...
      model.note = this.FormItem.controls.note.value.value;
      model.patientInstruction = this.FormItem.controls.patientInstruction.value.name;
      model.route = this.FormItem.controls.route.value.code;
      model.doseType = this.FormItem.controls.doseType.value;
      model.doseUnitOrRangeMin = this.FormItem.controls.min.value || this.FormItem.controls.doseUnit.value.name;
      model.doseRangeMax = this.FormItem.controls.max.value || this.FormItem.controls.doseQuantity.value;
      model.rateType = this.FormItem.controls.rateType.value.code;
      model.rateRatioNumeratorMin = this.FormItem.controls.numerator.value.description || this.FormItem.controls.ratemin.value ||this.FormItem.controls.rateQuantity.value;
