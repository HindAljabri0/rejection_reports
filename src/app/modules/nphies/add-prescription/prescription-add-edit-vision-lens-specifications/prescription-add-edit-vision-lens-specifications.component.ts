...
@Component({
  selector: 'app-prescription-add-edit-vision-lens-specifications',
  templateUrl: './prescription-add-edit-vision-lens-specifications.component.html',
  styles: []
})
export class PrescriptionAddEditVisionLensSpecificationsComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PrescriptionAddEditVisionLensSpecificationsComponent>, @Inject(MAT_DIALOG_DATA) public data,
