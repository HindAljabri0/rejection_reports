...
@Component({
  selector: 'app-prescription-manage-supporting-info',
  templateUrl: './prescription-manage-supporting-info.component.html',
  styleUrls: ['./prescription-manage-supporting-info.component.css']
})
export class PrescriptionManageSupportingInfoComponent implements OnInit {
