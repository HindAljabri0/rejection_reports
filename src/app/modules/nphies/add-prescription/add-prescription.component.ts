...
export class AddPrescriptionComponent implements OnInit {
    ...
    //model1: { transfer: boolean; isNewBorn: boolean; beneficiary: { firstName: string; secondName: string; thirdName: string; familyName: string; fullName: string; fileId: string; dob: string; gender: string; documentType: string; documentId: string; eHealthId: string; nationality: string; residencyType: string; contactNumber: string; maritalStatus: string; bloodGroup: string; preferredLanguage: string; emergencyPhoneNumber: string; email: string; addressLine: string; streetLine: string; city: string; state: string; country: string; postalCode: string; }; subscriber: any; destinationId: any; insurancePlan: { payerId: string; memberCardId: string; policyNumber: string; maxLimit: string; patientShare: string; coverageType: string; relationWithSubscriber: string; expiryDate: string; payerName: string; payerNphiesId: string; primary: boolean; tpaNphiesId: any; }; preAuthorizationInfo: { dateOrdered: string; payeeId: number; payeeType: string; type: string; subType: string; eligibilityOfflineDate: any; eligibilityOfflineId: string; eligibilityResponseId: string; eligibilityResponseUrl: string; episodeId: any; }; supportingInfo: { sequence: number; category: string; code: string; fromDate: string; toDate: string; value: number; reason: string; attachment: string; attachmentName: string; attachmentType: string; attachmentDate: string; }[]; diagnosis: { sequence: number; diagnosisDescription: string; type: string; onAdmission: string; diagnosisCode: string; }[]; careTeam: { sequence: number; practitionerName: string; physicianCode: string; practitionerRole: string; careTeamRole: string; speciality: string; specialityCode: string; qualificationCode: string; }[]; items: { sequence: number; type: string; itemCode: string; itemDescription: string; nonStandardCode: string; nonStandardDesc: string; isPackage: boolean; bodySite: string; subSite: string; quantity: number; quantityCode: string; patientSharePercent: number; patientShare: number; payerShare: number; startDate: string; endDate: string; strength: string; absenceScientificCode: string; careTeamSequence: number[]; diagnosisSequence: number[]; claimItemDosageModel: { note: string; patientInstruction: string; route: string; doseType: string; doseRangeMax: number; doseUnitOrRangeMin: number; rateType: string; rateRatioNumeratorMin: number; rateRatioDenominatorMax: number; rateUnit: string; startDate: string; endDate: string; refill: string; duration: string; frequency: number; period: string; durationUnit: string; periodUnit: string; }[]; invoiceNo: any; itemDetails: { sequence: number; type: string; code: string; description: string; nonStandardCode: string; quantity: number; nonStandardDesc: any; itemDetailId: any; quantityCode: any; strength: string; absenceScientificCode: string; claimItemDetailsDosage: { note: string; patientInstruction: string; route: string; doseType: string; doseRangeMax: number; doseUnitOrRangeMin: number; rateType: string; rateRatioNumeratorMin: number; rateRatioDenominatorMax: number; rateUnit: string; startDate: string; endDate: string; refill: string; duration: string; frequency: number; period: string; durationUnit: string; periodUnit: string; }[]; }[]; }[]; };
    constructor(
