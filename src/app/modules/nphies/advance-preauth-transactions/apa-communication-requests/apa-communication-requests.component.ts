...
@Component({
  selector: 'app-apa-communication-requests',
  templateUrl: './apa-communication-requests.component.html',
  styles: []
})
export class ApaCommunicationRequestsComponent implements OnInit {
    ...
    getCommunicationRequests() {
      ...
      this.providerNphiesSearchService.getApaRequests(this.sharedServices.providerId, 'approval', this.page, this.pageSize).subscribe((event: any) => {
